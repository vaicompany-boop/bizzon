...
export const toolSeoEntries: Record<string, ToolSeoEntry> = {
  ...
  'random-picker': {
    ...
    summary: 'Use this free online random picker to choose names, winners, tasks, meals, ideas, or options from a simple list.',
    steps: ['Paste one item per line.', 'Choose whether to pick one, pick several, or shuffle the list.', 'Use the result for a decision, draw, rotation, or random order.'],
    useCases: ['Pick giveaway winners, chores, names, teams, restaurants, meals, and tasks.', 'Shuffle a list into a random order for games, planning, or rotations.', 'Make low-stakes decisions quickly without opening a spreadsheet.'],
    faqs: [
      { question: 'Can it pick more than one item?', answer: 'Yes. You can draw multiple items or shuffle the entire list.' },
      { question: 'Is my list uploaded?', answer: 'No. The list stays in your browser.' },
      { question: 'Can I use it for giveaways?', answer: 'It can help with simple random draws, but you should still follow any contest rules that apply to your situation.' },
    ],
    related: [
      { label: 'Text Cleaner', href: '/text-cleaner', reason: 'to clean copied lists' },
      { label: 'Password Generator', href: '/password-generator', reason: 'for secure random passwords' },
      { label: 'Date Calculator', href: '/date-calculator', reason: 'for planning dates and deadlines' },
    ],
  },
  'unit-converter': {
    slug: 'unit-converter',
